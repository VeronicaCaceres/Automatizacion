...
@Test(groups={"GrupoDespegar"}, description = "Validar la seccion alojamiento de la web Despegar.com", dataProvider="Destino")
...
@Test(groups={"BotonesMenu"},description = "Prueba Botones Menu")
